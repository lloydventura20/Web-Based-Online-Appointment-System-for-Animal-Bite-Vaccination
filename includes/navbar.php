...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard.php">
    ...
    <div class="sidebar-brand-text mx-3">ABTC</div>
</a>
...
<li class="nav-item">
    ...
    <div id="collapseTen" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="walk-in.php">Walk-in Registrtation</a>
        </div>
    </div>
</li>
...
<li class="nav-item">
    <a class="nav-link" href="consult.php">
        ...
        <span>Patient Assessment</span></a>
</li>
<!-- queue -->
<!-- <li class="nav-item">
    <a class="nav-link" href="patient-queue.php">
        <i class="fas fa-fw fa-table"></i>
        <span>Patient Queue 1</span></a>
</li> -->

<li class="nav-item">
    <a class="nav-link" href="patient-que.php">
        <i class="fas fa-fw fa-table"></i>
        <span>Patient Queue</span></a>
</li>
...
<li class="nav-item">
    <a class="nav-link" href="patient_report.php">
        <i class="fas fa-fw fa-clipboard"></i>
        <span>Patient Report</span></a>
</li>

<li class="nav-item">
    <a class="nav-link" href="summary-report.php">
        <i class="fas fa-fw fa-clipboard"></i>
...
<hr class="sidebar-divider d-none d-md-block">
<!-- <li class="nav-item">
    <a class="nav-link" href="view-patient-queue.php">
        <i class="fas fa-fw fa-eye"></i>
        <span>View Patient Queue</span></a>
</li> -->

<li class="nav-item">
    <a class="nav-link" href="live-monitor.php">
        <i class="fas fa-fw fa-eye"></i>
